...
struct Generalized_dual_grothendieck_polynomial	
{
    Polynomial ans;
    string lambda, mu;
    int M, n;
    ...
    vector < vector < vector < int > > > pps;

    Generalized_dual_grothendieck_polynomial () {}

    Generalized_dual_grothendieck_polynomial (string _lambda, string _mu, int _m): lambda(_lambda), mu(_mu), M(_m) {}
...
Polynomial generalized_dual_grothendieck(string lambda, string mu, int m)
{
    Generalized_dual_grothendieck_polynomial G(lambda, mu, m);
    return G.solve();
}
